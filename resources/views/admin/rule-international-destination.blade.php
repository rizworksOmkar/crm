    ...
    <div class="col-12 col-md-6 col-lg-6">
        <div class="card">
            <div class="card-header">
                <h4>Internatioal Destination Tile</h4>
            </div>
            <div class="card-body">
                ...
                <div class="form-group row">
                        ...
                        <select name="id" id="id1" class="form-control form-control-sm">
                            <option value="">
                                @if (isset($tiles[1]['selected_destination']))
                                    <p>Selected Destination: {{ $tiles[1]['selected_destination']->destination_name }}</p>
                                @else
                                    Select Destination
                                @endif
                            </option>
                    ...
                    <div class="col-sm-2">
                        <div class="buttons">
                            <a href="#" class="btn btn-icon btn-danger" id="del1"><i class="fas fa-times"></i></a>
                        </div>
                ...
                <div class="form-group row">
                        ...
                        <select name="id" id="id2" class="form-control form-control-sm">
                            <option value="">
                                @if (isset($tiles[2]['selected_destination']))
                                    <p>Selected Destination: {{ $tiles[2]['selected_destination']->destination_name }}</p>
                                @else
                                    Select Destination
                                @endif
                            </option>
                    ...
                    <div class="col-sm-2">
                        <div class="buttons">
                            <a href="#" class="btn btn-icon btn-danger" id="del2"><i class="fas fa-times"></i></a>
                        </div>
                ...
                <div class="form-group row">
                        ...
                        <select name="id" id="id3" class="form-control form-control-sm">
                            <option value="">
                                @if (isset($tiles[3]['selected_destination']))
                                    <p>Selected Destination: {{ $tiles[3]['selected_destination']->destination_name }}</p>
                                @else
                                    Select Destination
                                @endif
                            </option>
                    ...
                    <div class="col-sm-2">
                        <div class="buttons">
                            <a href="#" class="btn btn-icon btn-danger" id="del3"><i class="fas fa-times"></i></a>
                        </div>
                ...
                <div class="form-group row">
                        ...
                        <select name="id" id="id4" class="form-control form-control-sm">
                            <option value="">
                                @if (isset($tiles[4]['selected_destination']))
                                    <p>Selected Destination: {{ $tiles[4]['selected_destination']->destination_name }}</p>
                                @else
                                    Select Destination
                                @endif
                            </option>
                    ...
                    <div class="col-sm-2">
                        <div class="buttons">
                            <a href="#" class="btn btn-icon btn-danger" id="del4"><i class="fas fa-times"></i></a>
                        </div>
                ...
                <div class="form-group row">
                        ...
                        <select name="id" id="id5" class="form-control form-control-sm">
                            <option value="">
                                @if (isset($tiles[5]['selected_destination']))
                                    <p>Selected Destination: {{ $tiles[5]['selected_destination']->destination_name }}</p>
                                @else
                                    Select Destination
                                @endif
                            </option>
                    ...
                    <div class="col-sm-2">
                        <div class="buttons">
                            <a href="#" class="btn btn-icon btn-danger" id="del5"><i class="fas fa-times"></i></a>
                        </div>
                ...
                <div class="form-group row">
                        ...
                        <select name="id" id="id6" class="form-control form-control-sm">
                            <option value="">
                                @if (isset($tiles[6]['selected_destination']))
                                    <p>Selected Destination: {{ $tiles[6]['selected_destination']->destination_name }}</p>
                                @else
                                    Select Destination
                                @endif
                            </option>
                    ...
                    <div class="col-sm-2">
                        <div class="buttons">
                            <a href="#" class="btn btn-icon btn-danger" id="del6"><i class="fas fa-times"></i></a>
                        </div>

                    </div>
                </div>
                <div class="form-group row">
                    <label for="id" class="col-sm-3 col-form-label">Select Tile 7</label>
                    <div class="col-sm-7">
                        <input type="hidden" name="tile7" value="7">
                        <select name="id" id="id7" class="form-control form-control-sm">
                            <option value="">
                                @if (isset($tiles[7]['selected_destination']))
                                    <p>Selected Destination: {{ $tiles[7]['selected_destination']->destination_name }}</p>
                                @else
                                    Select Destination
                                @endif
                            </option>
                    ...
                    <div class="col-sm-2">
                        <div class="buttons">
                            <a href="#" class="btn btn-icon btn-danger" id="del7"><i class="fas fa-times"></i></a>
                        </div>

                    </div>
                </div>
                <div class="form-group row">
                    <label for="id" class="col-sm-3 col-form-label">Select Tile 8</label>
                    <div class="col-sm-7">
                        <input type="hidden" name="tile8" value="8">
                        <select name="id" id="id8" class="form-control form-control-sm">
                            <option value="">
                                @if (isset($tiles[8]['selected_destination']))
                                    <p>Selected Destination: {{ $tiles[8]['selected_destination']->destination_name }}</p>
                                @else
                                    Select Destination
                                @endif
                            </option>
                    ...
                    <div class="col-sm-2">
                        <div class="buttons">
                            <a href="#" class="btn btn-icon btn-danger" id="del8"><i class="fas fa-times"></i></a>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            $('#id1').on('change', function() {
                ...
                $.ajax({
                    url: "{{ route('admin.ruleengine.store') }}", // the url where you want to POST
                    type: 'POST',
                    data: {
            ...
            $('#id7').on('change', function() {
                var destinationId = $(this).val(); // get the selected destination id
                var tile = $('input[name=tile7]').val(); // get the tile number
                $.ajax({
                    url: "{{ route('admin.ruleengine.store') }}", // the url where you want to POST
                    type: 'POST',
                    data: {
            ...
            //for id8
            $('#id8').on('change', function() {
                var destinationId = $(this).val(); // get the selected destination id
                var tile = $('input[name=tile8]').val(); // get the tile number
                $.ajax({
                    url: "{{ route('admin.ruleengine.store') }}", // the url where you want to POST
                    type: 'POST',
                    data: {
                ...
                swal({
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            ...
                            // Check Exist Or Not
                            $.ajax({
                                url: "{{ route('admin.ruleengine.INT.exist') }}", // the url where you want to POST
                                type: 'GET',
                                data: {
                                    _token: '{{ csrf_token() }}', // add csrf token to the data                       
                                    tile: tile // pass the tile number to the data
                                ...
                                success: function(response) {
                                    if (response.message == 'success') {
                                        // Delete Rule
                                        $.ajax({
                                            url: "{{ route('admin.ruleengine.INT.Delete') }}",
                                            method: 'post',
                                            data: {
                                                "_token": "{{ csrf_token() }}",
                                                tile: tile 
            ...
            // Tile 7 Delete
            $("#del7").click(function() {
                var tile = $('input[name=tile7]').val();
                swal({
                        title: "Do you want to delete your selected Tile 7?",
                        text: "Once deleted, you will never get this Tile 7 back. It will have to be rebuilt a new ",
                        icon: "warning",
                        buttons: true,
                        showCancelButton: true,
                        dangerMode: true,
                                    ...
                                    if (response.message == 'success') {
                                        ...
                                        $.ajax({
                                            ...
                                            success: function(response) {
                                                swal({
                                                    icon: "success",
                                                    text: "Tile 7 deleted successfully",
                                                }).then((willconfirm) => {
                                                    if (willconfirm) {
                                                        location
                                                        .reload();
                                        ...
                                        swal({
                                            title: "Error",
                                            text: "No Record Found at tile 7",
                                            icon: "error",
                                            button: "Ok",
                                        });
                                    }
            ...
            // Tile 8 Delete
            $("#del8").click(function() {
                var tile = $('input[name=tile8]').val();
                swal({
                        title: "Do you want to delete your selected Tile 8?",
                        text: "Once deleted, you will never get this Tile 8 back. It will have to be rebuilt a new ",
                        icon: "warning",
                        buttons: true,
                        showCancelButton: true,
                        dangerMode: true,
                                    ...
                                    if (response.message == 'success') {
                                        ...
                                        $.ajax({
                                            ...
                                            success: function(response) {
                                                swal({
                                                    icon: "success",
                                                    text: "Tile 8 deleted successfully",
                                                }).then((willconfirm) => {
                                                    if (willconfirm) {
                                                        location
                                                        .reload();
                                        ...
                                        swal({
                                            title: "Error",
                                            text: "No Record Found at tile 8",
                                            icon: "error",
                                            button: "Ok",
                                        });
                                    }
