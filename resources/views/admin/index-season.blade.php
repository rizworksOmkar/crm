        ...
        @foreach ($season as $data)
            <script>
                $('#deleteCountry_{{ $data->id }}').click(function() {
                    swal({
                            title: "Do you want to delete your selected SEASON?",
                            text: "Once deleted, you will never get this SEASON back. It will have to be rebuilt a new ",
                            icon: "warning",
                            buttons: true,
