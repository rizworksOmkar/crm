                    ...
                    <table class="table table-sm" id="tblSeason" style="font-size: 12px">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td>
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-sm" name="roomtype"
                                            id="roomtype">
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group">
                                        <select class="form-control-sm" id="selectBreakfast" name="selectBreakfast">
...
@section('scripts')
    <script>
        ...
        $('#addSeason').on('click', function() {
            ...
            $selectBreakfast = $('#selectBreakfast').val();
