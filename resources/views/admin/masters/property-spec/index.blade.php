                        ...
                        <div class="card-body">
                            <div class="grid items-center grid-cols-1 gap-3 mb-5 2xl:grid-cols-12">
                                <div class="xl:col-span-3">
                                    <h4 class="text-15">Property Specification</h4>
                                </div>
                                <!--end col-->
                            ...
                            <div id="addPropertySpecForm" style="display: none">
                                <div class="grid grid-cols-1 gap-x-5 xl:grid-cols-2 mt-2">
                                    <div class="card">
                                        <div class="card-body">
                                            <form id="add_property_spec_form" action="{{ route('property-specs.store') }}"
                                                ...
                                                <div class="mb-3">
                                                    <label class="inline-block mb-2 text-base font-medium"
                                                        for="property_spec">Add Property Spec
