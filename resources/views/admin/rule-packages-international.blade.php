...
@section('content')
    <section class="section">
        <div class="section-body">
            <h2 class="section-title">Rule Engine For International Packages.</h2>
            <div class="row">
    ...
    <script>
        ...
        $('#btnFilterbyCity').click(function(event) {
            ...
            if (city_id == 0) {
                ...
                $.ajax({
                    url: "{{ route('admin-homepage-INT-pacakages-City-get') }}",
                    type: "GET",
                    data: {
                        "_token": "{{ csrf_token() }}",
                        "cityid": city_id,
        ...
        $('#btnFilterbyNight').click(function(event) {
            ...
            if (night == '') {
                ...
                $.ajax({
                    url: "{{ route('admin-homepage-INT-pacakages-Night-get') }}",
                    type: "GET",
                    data: {
                        "_token": "{{ csrf_token() }}",
                        "night": night,
