            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-header-action">
                        ...
                        <a href="{{ route('admin-Amenities-add') }}" class="btn btn-primary">Add Amenities</a>
                    </div>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-hover" style="width:100%;" id="tableCity">
                            ...
                            <tbody>
                                @php $i=0; @endphp
                                @foreach ($hotelAmenities as $data)
                                    @php $i++; @endphp
                                    <tr>
                                        <th>{{ $i }}</th>
                                        ...
                                        <td>
                                            <div class="buttons">
                                                ...
                                                <a href="{{ url('/Amenities-edit/' . $data->id) }}"
        ...
        @foreach ($hotelAmenities as $data)
            <script>
                $('#deleteCountry_{{ $data->id }}').click(function() {
                    swal({
                            title: "Do you want to delete your selected AMENITIES?",
                            text: "Once deleted, you will never get this AMENITIES back. It will have to be rebuilt a new ",
                            icon: "warning",
                            buttons: true,
