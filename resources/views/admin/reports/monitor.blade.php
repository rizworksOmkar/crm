    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#filterValue').change(function() {
                ...
                if (filterValue) {
                    fetchLeads(filterType, filterValue);
                }
            });
            ...
            function fetchLeads(filterType, filterValue) {
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $.each(response, function(index, lead) {
                            rows += '<tr>' +
                                        ...
                                        '<td><button class="btn btn-sm btn-primary view-tasks-btn" data-lead-id="' + lead.id + '">View Tasks</button></td>' +
                                    '</tr>';
                        });
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $.each(response, function(index, task) {
                            taskDetails += '<p>' + task.description + ' - ' + task.date + ' - ' + task.status + '</p>';
                        });
