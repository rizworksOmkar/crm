        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <textarea class="form-control" cols="30" rows="10" id="txtpropertyrules" name="txtpropertyrules" placeholder="Input Propert Rules"> </textarea>
    ...
    <script>
        $(document).ready(function() {
            $('#add_property_form').submit(function(event) {
                ...
                $.ajax({
                    url: "{{ route('admin-hotelpropertyrules-store') }}",
                    type: "POST",
                    data: formData,
                    success: function(response) {
                        if (response.message == 'success') {
                            swal({
                                title: "Success",
                                text: "Property Rules Added Successfully",
                                icon: "success",
                                button: "Ok",
                            }).then((willconfirm) => {
                                if (willconfirm) {
                                    swal({
                                            title: "Are you want add more Property Rules?",
