        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4>Package Type Master</h4>
                    <div class="card-header-action">
                        <a href="{{ route('admin.packagetypemaster') }}" class="btn btn-primary">Add Package Type</a>
                    </div>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                ...
                                @foreach ($packagetypes as $data)
                                    ...
                                    <tr>
                                        ...
                                        <td> <img src="{{$data->icone_image}}" alt="{{ $data->package_type }}" ></td>
                                        <td>
                                            <div class="buttons">

                                                <a href="{{ url('/editPackagetypemaster/' . $data->id) }}"
                                                    class="btn btn-icon btn-sm btn-info" data-toggle="tooltip"
                                                    title="view and Edit Your Event"><i class="far fa-eye"></i></a>

                                                <a submitid="{{ $data->id }}"
                                                    class="btn btn-icon btn-sm btn-danger" data-toggle="tooltip"
                                                    title="Delete your Event" href="javacript:void(0)"
                                                    id="deletepackage_{{ $data->id }}"><i
...
@section('scripts')
    ...
    <script type="text/javascript">
     ...
     @foreach ($packagetypes as $data)
         <script>
             $('#deletepackage_{{ $data->id }}').click(function() {
                 swal({
                     ...
                     .then((willDelete) => {
                         if (willDelete) {
                             ...
                             $.ajax({
                                 url: "{{ route('admin-delete-for-package') }}",
                                 method: 'post',
                                 data: {
                                     "_token": "{{ csrf_token() }}",
                                     id: id
