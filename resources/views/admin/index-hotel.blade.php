            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-header-action">
                        <a href="{{ route('admin.hotelmaster') }}" class="btn btn-primary">Add Hotel</a>
                    </div>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                ...
                                @foreach ($hotels as $data)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ getPropertName($data->hotel_type) }}</td>
                                        <td>
                                            <div class="buttons">
     ...
     @foreach ($hotels as $data)
         <script>
             $('#deleteHotels_{{ $data->id }}').click(function() {
                 swal({
                         title: "Do you want to delete your selected HOTEL?",
                         text: "Once deleted, you will never get this HOTEL back. It will have to be rebuilt a new ",
                         icon: "warning",
                         buttons: true,
