                                            ...
                                            <div class="col-lg-4 col-md-12 col-sm-12 col-12">
                                                {{-- <div class="flight_Search_boxed flt_gos">
                                                    <div class="date_flex_area">
                                                        ...
                                                        <div class="frm_allCity width_100 d-none">
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="imgThumbList htl_subImg d-none">
                                                    <span class="imgThumbCont all_vw" id="all_vw"><img
                                                            class="imgThumb" src="/assets/user/img/hotel/hotel-list-1.png"
                                                            alt="hotel_image_1">
                                                    </span>
                                                    <span class="imgThumbCont all_vw" id="all_vw2"><img
                                                            class="imgThumb" src="/assets/user/img/hotel/hotel-list-2.png"
                                                            alt="hotel_image_2">
                                                    </span>
                                                    <span class="imgThumbCont all_vw" id="all_vw3"><img
                                                            class="imgThumb" src="/assets/user/img/hotel/hotel-list-3.png"
                                                            alt="hotel_image_3">
                                                    </span>
                                                    <span class="imgThumbCont all_vw" id="all_vw4"><img
                                                            class="imgThumb" src="/assets/user/img/hotel/hotel-list-4.png"
                                                            alt="hotel_image_4">
                                            ...
                                            <div class="col-lg-3">
                                                <div class="cruise_content_rate">
                                                    ...
                                                    <div
                                                        ...
                                                        <a href="/hotelDetails" class="btn btn_theme btn_md mb_15">View
                                                            details</a>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="cruise_content_top_wrapper">
                                                        <div class="cruise_content_top_left cruise_content_w_100">
                                                            ...
                                                            <div class="duration">
                                                                <p class="cruise_duration text_ellipsis">
                                                                    <i class="fas fa-map-marker-alt"></i>
                                                                    Salt Lake City - <span class="ct_cl">Kolkata</span>
                                                                </p>
                                                                <div class=" htl_lctnW">
                                                                    <span class="lctn_head">Nearest transporttion
                                                                        option</span>
