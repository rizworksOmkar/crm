            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="common_bannner_text">
                        <h2>Discount International Pacakages</h2>
                        <ul>
                            <li><a href="/">Home</a></li>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3 position-relative">
                                                <div class="cruise_item_img" style="width: 100%;">
                                                    <img src="/storage/admin/img/package-images/packagephoto_1717580340.png"
                                                ...
                                                <div class="cruise_item_inner_content">
                                                    <div class="cruise_content_top_wrapper">
                                                        <div class="cruise_content_top_left cruise_content_w_100">
                                                            ...
                                                            <h4>Amazing Trip To BANGKOK & PATTAYA</h4>
                                                            <ul>
