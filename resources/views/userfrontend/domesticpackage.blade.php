                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="cruise_item_inner_content">
                                                            <div class="cruise_content_top_wrapper">
                                                                ...
                                                                <div class="d-flex text_ellipsis">
                                                                    <p class="cuntry_sec"><i
                                                                            class="fas fa-map-marker-alt"></i>
                                                                        {{ getCountryName($item->country_id) }}</p>
                                                                        {{-- <p class="cuntry_st"> -> (kolkata)</p> --}}
                                                                </div>
                                                                </div>
                    ...
                    success: function(response) {
                        ...
                        $.each(response.packages, function(key, item) {
                            ...
                            $('#packages').append(
                                ...
                                '</ul>' +
                                '<div class="duration">' +
                                (item.noofdaysbycity != null ? '<p class="cruise_duration text_ellipsis">' + item.noofdaysbycity + '</p>' : '') +
                                '<p class="cruise_duration_hbr">' + item.noofdaysbycity + '</p>' +
                                '</div>' +
                                '<p><small>' + item.package_type + '</small></p>' +
                                '<p class="cuntry_sec text_ellipsis"><i class="fas fa-map-marker-alt"></i> ' + packageCountriesList + '</p>' +
                                '</div>' +
                                '</div>' +
                                '<div class="cruise_content_middel_wrapper">' +
                                '<div class="cruise_content_middel_left">' +
                                ...
                                '<div class="cruise_content_bottom_wrapper">' +
                                '<div class="cruise_content_bottom_left">' +
                                '<p class="cruise_content_bottom_activity"> <small class="text_ellipsis">' + packageActivitiesList + '</small>' +
                                '<span class="cruise_content_bottom_box">' + packageActivitiesList + '</span></p>' +
                                '</div>' +
                                '</div>' +
                                '</div>' +
                                '</div>' +
