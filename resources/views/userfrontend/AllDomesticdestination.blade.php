                        ...
                        @if ($destinationCount > 0)
                            @foreach ($destination as $item)
                                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                                    <a href="/domestic-package/{{ $item->id }}">
                                        <div class="top_destinations_box img_hover">
                                            ...
                                            <a href="/domestic-package/{{ $item->id }}"><img
                                                    src="{{ getDestiThumb_image($item->id) }}" alt="img"></a>
                                            <div class="top_destinations_box_content">
                                              <div class="ellps_hvr_box">
                                                  <h4><a
                                                        href="/domestic-package/{{ $item->id }}">{{ $item->destination_name }}</a>
                                                  </h4>
                                                  <p class="ellipsis_aftr"><a href="/international-package/{{ $item->id }}">{{$item->destination_name}}</a></p>
                                              </div>
                                              <div class="ellps_hvr_box">
                                                 <p class="text_ellipsis"><i
                                                 class="fas fa-map-marker-alt"></i>
                                                  {{ getCountryName($item->country_id) }}</p>
                                                <p class="ellipsis_aftr"><i
                                                   class="fas fa-map-marker-alt"></i>
                                                  {{ getCountryName($item->country_id) }}</p>
                                              </div>
                                              <div class="ellps_hvr_box">
                                                <p class="text_ellipsis"> {{getStateName($item->state_id) }}</p>
                                                <p class="ellipsis_aftr"> {{getStateName($item->state_id) }}</p>
                                             </div>
                                              <div class="ellps_hvr_box">
                                                <p class="text_ellipsis"><small style="color: #fff">{{getCityName($item->city_id)}}</small></p>
                                                <p class="ellipsis_aftr"><small style="color: #fff">{{getCityName($item->city_id)}}</small></p>
                                                </div>
                                                {{-- <p><span class="review_rating">4.8/5 Excellent</span> <span
                                                        class="review_count">(1214
                                                        reviewes)</span></p> --}}
