            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="common_bannner_text">
                        ...
                        <h2>Fixed Departure International Pacakages </h2>


                        <ul>
                            <li><a href="/">Home</a></li>
                            <li><span><i class="fas fa-circle"></i></span>Fixed Departure</li>
                        </ul>
                    </div>
                </div>
            </div>
                                                ...
                                                <div class="flight_Search_boxed ">
                                                    ...
                                                    <div class="date_flex_area">
                                                        <div class="frm_allCity width_100">
                                                            ...
                                                            <select class="slct_fmTo" name="ddlCityName" id="ddlCityName">
                            ...
                            <form id="filterForm">
                                ...
                                <div class="left_side_search_boxed">
                                    ...
                                    <div class="tour_search_type">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="rdoBudget"
                                                value="100001,999999" id="flexBudget7">
