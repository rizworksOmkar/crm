...
@section('content')
    <div class="dashboard_common_table">
        ...
        <input type="hidden" class="form-control numberonly" value={{ $bookingID }} id="hdbBookingID"
            name="hdbBookingID" />
        <input type="hidden" class="form-control numberonly" value={{ Auth::user()->id }} id="hdbUserID"
            name="hdbUserID" />
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control numberonly" id="noofadult" name="noofadult" value="{{$adults}}" />
                        </div>
                    </div>
                            ...
                            <table class="table table-striped table-hover" id="tblAdultDetails" style="width: 100%" >
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="form-control text-capitalize" id="ridername" id="ridername" />
                                        </td>
                                        <td>
                                            <input type="text" class="form-control numberonly" id="riderAge"
                                                id="riderAge" />
                                        </td>
                                        <td>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control numberonly" id="noofchild" id="noofchild" value="{{$childs}}"/>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <table class="table table-striped table-hover" id="tblChildDetails" style="width: 100%">
                                ...
                                <tfoot>
                                    <tr>
                                        <td>
                                            <input type="text" class="form-control text-capitalize" id="riderChildname"
                                                id="riderChildname" />
                                        </td>
                                        <td>
                                            <input type="text" class="form-control numberonly" id="riderChildAge"
                                                id="riderChildAge" />
                                        </td>
                                        <td>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control numberonly" id="noofinfant" id="noofinfant" value="{{$infants}}"/>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <table class="table table-striped table-hover" id="tblInfantDetails" style="width: 100%">
                                ...
                                <tfoot>
                                    <tr>
                                        <td>
                                            <input type="text" class="form-control text-capitalize" id="riderInfantname"
                                                id="riderInfantname" />
                                        </td>
                                        <td>
                                            <input type="text" class="form-control numberonly" id="riderInfantAge"
                                                id="riderInfantAge" />
                                        </td>
                                        <td>
