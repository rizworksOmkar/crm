    ...
    <div class="dashboard_common_table">
        ...
        <div class="profile_update_form">
            <form id="booking_form">
                {{ csrf_field() }}
                <div class="row">
                    <input type="hidden" class="form-control numberonly" value="{{ $details->id }}" id="hdbBookingID"
                    name="hdbBookingID" />

                    <input type="hidden" class="form-control numberonly" value="{{ $bookingID }}" id="hdbBookingcode"
                    name="hdbBookingcode" />
                    <div class="col-lg-4">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select select2" name="selectcity" id="selectcity">
                                ...
                                @foreach ($cities as $city)
                                    <option value="{{ $city->id }}" {{ $city->id == $details->city_id ? 'selected' : '' }}>
                                        {{ $city->city_name }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="journeyDate"
                                name="journeyDate" value="{{ $details->journey_date }}">
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control" id="hdnPacakgeID" name="hdnPacakgeID"
                                value="{{ $details->pacakge_id }}">                          
                            <input type="text" class="form-control" id="pacakageName" name="pacakageName"
                                value="{{ getpackageName($details->pacakge_id) }}" readonly>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="form-group usr_ipt_grp flx_sp_bwn">
                            ...
                            <input type="text" class="form-control" id="pacakagePrice" name="pacakagePrice"
                                value="{{ $details->pacakge_cost }}" readonly>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label for="bookAddress">Address</label>
                            <textarea class="form-control" id="bookAddress" name="bookAddress">{!! $details->user_address !!} </textarea>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="form-group">
                            <label for="bookState">State</label>
                            <input type="text" class="form-control" id="bookState" name="bookState" value="{{ $details->user_state }}"/>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="form-group">
                            <label for="bookCity">City</label>
                            <input type="text" class="form-control" id="bookCity" name="bookCity" value="{{ $details->user_city }}" />
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="form-group">
                            <label for="bookCountry">Country</label>
                            <input type="text" class="form-control" id="bookCountry" name="bookCountry" value="{{ $details->user_country }}"/>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="form-group">
                            <label for="bookPincode">PinCode</label>
                            <input type="text" class="form-control numberonly" id="bookPincode" name="bookPincode" value="{{ $details->user_pincode }}"/>
                        </div>
                    </div>
                </div>
            </form>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.message == 'success') {
                        ...
                        window.location = '/user/viewBooking/' + response.bookingID;
                    } else {
                    }
