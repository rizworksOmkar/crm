...
<body>
    ...
    <body
                                ...
                                <div class="relative flex items-center dropdown h-header">
                                    <button type="button"
                                        ...
                                        <span class="absolute top-0 right-0 flex w-1.5 h-1.5">
                                            ...
                                            <span
                                                class="relative inline-flex w-1.5 h-1.5 rounded-full bg-sky-500"></span>
                                        </span>
                                    </button>
                ...
                <div class="mt-6" id="sidebar-color">
                    ...
                    <div class="flex flex-wrap gap-3">
                        <button type="button" id="sidebarColorOne" name="sidebarColor" value="light"
                            ...
                            <i data-lucide="check"
                                class="w-5 h-5 hidden group-[.active]:inline-block text-slate-600"></i>
                        </button>
        ...
        {{-- <script
            src="{{ asset('assets/admin/bundles/datatables/DataTables-1.10.16/js/dataTables.bootstrap4.min.js') }}">
            --}}
    {{-- 
        </script> --}}
        ...
        <!-- Cropring Iamges -->
        {{-- <script type="text/javascript" src="{{ asset('assets/admin/croperimgages/scripts/jquery.Jcrop.js') }}">
        </script> --}}
        {{-- <script type="text/javascript"
            src="{{ asset('assets/admin/croperimgages/scripts/jquery.SimpleCropper.js') }} ">
            --}}
    {{-- 
        </script> --}}
        <script>
