...
<body style="position: relative;"
    ...
    <div id="app" class="group-data-[sidebar-size=sm]:min-h-sm
     group-data-[sidebar-size=sm]:relative">
        <div
            ...
            <div
                ...
                <a href="index.html"
                    ...
                    <span class="group-data-[sidebar-size=sm]:hidden">
                        <img src="{{ asset('/assets/admin/OldAssets/img/logo.png') }}" alt=""
                            class="h-6 mx-auto" />
                    </span>
                            ...
                            <div class="relative flex items-center dropdown h-header">
                                <button type="button"
                                    ...
                                    <div class="bg-pink-100 rounded-full">
                                        <img src="/assets/admin/images/user.jfif"
